...
<div class="lifecycle">
  <article class="lc-card" data-lvl="gold">
    <header class="lc-head">
      <span class="dot" data-lvl="gold" aria-hidden="true"></span>      <h2>煤炭</h2>
  ...
  <article class="lc-card" data-lvl="gold">
    <header class="lc-head">
      <span class="dot" data-lvl="gold" aria-hidden="true"></span>      <h2>钢铁</h2>
      <span class="badge" data-lvl="gold" data-kind="stage">积极推进</span>
    </header>
    <div class="lc-stats">
  ...
  <article class="lc-card" data-lvl="red">
    <header class="lc-head">
      <span class="dot" data-lvl="red" aria-hidden="true"></span>      <h2>医药</h2>
